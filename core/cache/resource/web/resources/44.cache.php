...
if ($discountPercent > 0 && $originalRentalAmount > 0) {
    ...
    $out .= \'              <span style="display:block; color:#d62828; font-size:16px; font-weight:700;">€ \' . number_format($rentalAmount, 2, \'.\', \',\') . \'</span>\';
    $out .= \'            </strong>\';
    $out .= \'          </div>\';
...
if (needChauffeur && needChauffeur.value === "yes") {
    chauffeurFee = chauffeurFeePerDay * days;
        ...
        var finalTotal = baseTotal + chauffeurFee + licenseFee;
...
$out .= \'      <div id="bookingPdfStatus" class="bookingPdfStatus">Generating your PDF...</div>\';
