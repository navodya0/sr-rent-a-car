...
AIzaSyB7vPsBQR4bp2RDm7Iz5u6hN1VzGnqtwsI&libraries=places&callback=initAutocomplete" async defer></script>
...
document.addEventListener(\'DOMContentLoaded\', () => {
  ...
  const showDefaultView = () => {
    ...
    groups.forEach(group => {
      // Skip the "recommended for you" group — show ALL vehicles in it
      if (group.classList.contains(\'selected-vehicle-group\')) {
...
[[+requires_driver:is=`1`:then=`
      <div class="dealCard__driverNote" style="color:#d9534f; font-weight:600; margin-top:8px;">
        **This vehicle is available only with a driver, and a driver charge will be added to your total.
      </div>
    `]]
  </div>
...
if ($_SERVER[\'REQUEST_METHOD\'] === \'POST\') {
    ...
    $_SESSION[\'rent_search\'] = [
        ...
        \'selected_vehicle_id\' => (int)($_POST[\'selected_vehicle_id\'] ?? 0),
    ];
...
if (!function_exists(\'isDriverOnlyCategory\')) {
    function isDriverOnlyCategory($category, $list) {
        return in_array(strtolower(trim((string)$category)), $list, true);
    }
}
...
$passengerCount = (int)($search[\'passenger_count\'] ?? 0);
$luggageCount   = (int)($search[\'luggage_count\'] ?? 0);
$same = ($dropoff === \'\');
...
$out .= \'    <div class="rentWidget__row">\';
$out .= \'      <div class="rentWidget__label">Passenger count</div>\';
$out .= \'      <div class="rentWidget__box">\';
$out .= \'        <input class="rentWidget__input" type="number" name="passenger_count" value="\'.$h($passengerCount > 0 ? $passengerCount : \'\').\'" placeholder="No. of passengers" min="1">\';
$out .= \'      </div>\';
$out .= \'    </div>\';

$out .= \'    <div class="rentWidget__row">\';
$out .= \'      <div class="rentWidget__label">Luggage count</div>\';
$out .= \'      <div class="rentWidget__box">\';
$out .= \'        <input class="rentWidget__input" type="number" name="luggage_count" value="\'.$h($luggageCount > 0 ? $luggageCount : \'\').\'" placeholder="No. of luggage" min="0">\';
$out .= \'      </div>\';
$out .= \'    </div>\';
