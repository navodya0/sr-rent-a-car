...
<div class="bookingStepTopbar mb-4">
  ...
  <a href="[[~41]]" class="bookingStepTopbar__back">
    ← Back to your deal
  </a>
...
<div class="bookingStepTopbar mb-4">
  ...
  <a href="index.php?id=41" class="bookingStepTopbar__back">
    ← Back to your deal
  </a>
...
if ($discountAppliesToThisVehicle && $baseRentalOriginal > 0) {
    ...
    $out .= \'        <span class="discount" style="display:block; color:#d62828; font-size:22px; font-weight:700;">€ \' . number_format($baseRental, 2, \'.\', \'\') . \'</span>\';
    $out .= \'      </strong>\';
