...
$out .= '                <select name="payment_option" id="payment_option" class="form-control driverForm__control" required disabled>';
$out .= '                  <option value="pay_on_arrival" selected>Pay on arrival</option>';
$out .= '                </select>';
$out .= '                <input type="hidden" name="payment_option" value="pay_on_arrival">';
$out .= '              </div>';
$out .= '            </div>';
$out .= '          </div>'; -->
...
<!-- $out .= '          <div id="payOnArrivalNotice" class="payLaterNotice" style="display:none;">';
$out .= '              <div class="payLaterNotice__icon">💡</div>';
$out .= '              <div class="payLaterNotice__content">';
$out .= '                  <h4 class="payLaterNotice__title">Get more benefits by paying now</h4>';
$out .= '                  <p class="payLaterNotice__text">Pay now to enjoy special offers on full or half payments and secure your vehicle reservation right away.</p>';
$out .= '                  <ul class="payLaterNotice__list">';
$out .= '                      <li>Exclusive offers for full payment</li>';
$out .= '                      <li>Convenient half payment choices</li>';
$out .= '                      <li>Instant vehicle reservation</li>';
$out .= '                  </ul>';
$out .= '              </div>';
$out .= '          </div>'; -->
...
$out .= '<script>
  document.addEventListener("DOMContentLoaded", function () {
      ...
      var payOnArrivalNotice = document.getElementById("payOnArrivalNotice");
      ...
      function togglePaymentButton() {
          ...
          if (paymentOption.value === "pay_on_arrival") {
              ...
              if (payOnArrivalNotice) {
                  payOnArrivalNotice.style.display = "flex";
              }
          } else if (paymentOption.value === "pay_now") {
              bookingSubmitBtn.textContent = "Continue to Payment";
              if (payOnArrivalNotice) {
                  payOnArrivalNotice.style.display = "none";
              }
          } else {
              bookingSubmitBtn.textContent = "Continue to Payment";
              if (payOnArrivalNotice) {
