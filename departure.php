...
<head>
  ...
  <title>Staff Evaluation - Departure</title>
...
<body class="bg-light">
  ...
  <div class="container py-5">
    ...
    <div class="text-center mb-4">
      ...
      <h1>Staff Evaluation on the Departure</h1>
    </div>

    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="home.php">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Staff Evaluation - Departure</li>
      </ol>
    </nav>

    <div class="card shadow-sm mb-5">
      <div class="card-body">
        <h4 class="card-title mb-3">Departure / Checkout Checklist</h4>
        <form id="checkoutForm" class="needs-validation" novalidate method="POST" action="save_evaluation_departure.php">
          ...
          <div class="row align-items-center mb-1">
            <div class="col-md-9">
              <label class="form-label fw-semibold">1. Greeting</label>
            </div>
            <div class="col-md-3">
          ...
          <div class="row align-items-center mb-1">
            <div class="col-md-9">
              <label class="form-label fw-semibold">2. Attempt for Review by Friendly & Polite Conversation (Holiday)</label>
            </div>
            <div class="col-md-3">
              <select name="review_attempt" class="form-select" required>
                <option value="" disabled selected>Select Your Rate</option>
                <option>1</option><option>2</option><option>3</option><option>4</option><option>5</option>
              </select>
            </div>
          ...
          <div class="row align-items-center mb-1">
            <div class="col-md-9">
              <label class="form-label fw-semibold">3. Vehicle Inspection</label>
            </div>
            <div class="col-md-3">
          ...
          <div class="row align-items-center mb-1">
            <div class="col-md-9">
              <label class="form-label fw-semibold">4. Accurate Additional Charge</label>
            </div>
            <div class="col-md-3">
              <select name="additional_charge" class="form-select" required>
                <option value="" disabled selected>Select Your Rate</option>
                <option>1</option><option>2</option><option>3</option><option>4</option><option>5</option>
              </select>
            </div>
          ...
          <div class="row align-items-center mb-1">
            <div class="col-md-9">
              <label class="form-label fw-semibold">5. Big Smile & Friendly Goodbye</label>
            </div>
            <div class="col-md-3">
              <select name="friendly_goodbye" class="form-select" required>
                <option value="" disabled selected>Select Your Rate</option>
                <option>1</option><option>2</option><option>3</option><option>4</option><option>5</option>
              </select>
            </div>
